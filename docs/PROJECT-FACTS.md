# 221–223 Waverly Avenue — Verified Project Facts

Sources, all StudioSC Architecture:
- **GC set** — `223_WAVERLY_AVENUE_GC_PAA_1.pdf`, Job 341-24,
  DOB NOW Job # B01078929-I1, PAA 1 dated 08/15/25 (223 only)
- **LPC set** — `2024.12.17_WAVERLY_LANDMARKS_PRESENTATION.pdf`,
  Landmarks Preservation Commission presentation, 17 Dec 2024 (221 **and** 223)
...
| MEP engineer | All City Engineering, P.C. |
| DOB consultant | BMB Building Consultants |

## Dimensions & area
| Field | Value |
|---|---|
| Lot (each) | 18'-9" wide x 100' deep = 1,875 SF |
| Building coverage | 1,029 SF (54.87%) |
| Building height | 41'-7" (max permitted 55'-0") |
| Stories | 4 + roof bulkhead |
| Gross floor area — 1st | 1,009.11 SF |
| Gross floor area — 2nd | 935.56 SF |
...
|---|---|---|
| 1st floor | 75.39' (0'-0") | 10'-3" |
| 2nd floor | 86.81' (10'-3") | 10'-3" |
| 3rd floor | 97.06' (20'-6") | 10'-3" |
| 4th floor | 107.31' (30'-9") | 10'-10" |
| Roof | 118.14' (41'-7") | — |
| Bulkhead | 126.64' (50'-1") | — |

Ceiling heights per RCP: 9'-0" typical living spaces, 10'-0" at 1st floor,
8'-2" at bathrooms/closets (dropped ceilings 6"/12"/18").

## Room program (LPC plans, Dec 2024 — both houses, mirrored)
...
- **SK1N Terra PG terracotta cladding** (rainscreen panel system)
- Aluminum coping, sills, window extrusions and canopy in **Terra Brown RAL 8028**
- Stucco at rear
- Sculpted facade profile with a curved parapet and a **4'-0" diameter round window**
- 1-hr rated exterior assemblies (UL H505), STC 50 / IIC 50
- 2" continuous XPS rigid insulation + batt; calculated U-value 0.048
- Floor assembly: 5/8" hardwood finish / plywood / **Ecore QT acoustic underlayment**
  / Homasote 440 soundbarrier / VersaRoc — i.e. an acoustically isolated floor
- Concrete pavers on adjustable pedestals at terraces; 4" roof water detention
- Windows: trickle-vented (Titan), sound attenuators, incl. a **4'-0" diameter
  round window (W6)** and 3'-0" x 8'-0" full-height fixed units (W1A)
...
and arched openings, light rift-oak millwork with recessed pulls, fluted-glass
upper cabinets, book-matched green-veined marble (Calacatta Viola / Verde style)
on kitchen counters, island and full-height backsplash, plaster range hood,
wide-plank pale oak floors, terracotta/brick-toned patterned tile at the entry,
bouclé and cream upholstery, red-marble accent pieces.

Decisions still shown as **options** (a buyer-facing site must not show all four):
- Typical bath with tub — Option 1 vs Option 2
- Powder room — Options 1, 2, 3, 4
- Bath with shower — with vs without stone shelf
...
176 Washington Park · 39 South Elliot Place

## Asset inventory in this repo
- `assets/renderings/` — 27 interior renderings, 2400x1350 to 3200x1800 JPEG
- `assets/materials/` — 21 material/fixture swatch images
- `assets/exterior/` — 4 rendered site-context views + their matching existing-condition
  photos (low resolution — see Open Questions)
- `assets/landmarks/` — streetscape/context photography + 14 LPC sheets at 150 DPI
  (zoning envelope, block plan, long section, street elevation, elevations, facade
  details, floor plans cellar through roof)
- `assets/drawings/` — 7 GC sheets at 150 DPI
